...
pl = dict(
    CFBundleIdentifier='dev.lizardbyte.plugger',
    PlexAgentAttributionText="""
        <![CDATA[
            ...
            <div class="center">
                <strong>Plugger</strong><br>
            </div>
            <br>
            A plugin by <a href="https://app.lizardbyte.dev" target="_blank">LizardByte</a> that allows you to easily
            ...
            <table>
                <tr>
                    <td>Version:  %s</td>
                    <td>%s</td>
                    <td>| <a href="https://github.com/LizardByte/Plugger/releases/latest"
            ...
            <table>
                <tr>
                    ...
                    <td>| <i class="fas fa-fw fa-file-lines"></i> <a
                            href="https://docs.lizardbyte.dev/projects/plugger" target="_blank">Docs</a></td>
                </tr>
            </table>
        ]]>
    """ % (checked, version),
